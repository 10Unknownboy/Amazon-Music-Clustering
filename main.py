...
def main():
    ...
    plot_silhouette_scores(k_results["k_range"], k_results["silhouette_scores"], optimal_k)
    ...
    hierarchical_labels, hierarchical_model = run_hierarchical(X, n_clusters=optimal_k)
    ...
    cluster_profiles = profile_clusters(selected_features, kmeans_labels, CLUSTERING_FEATURES)
    ...
    # t-SNE scatter plot (K-Means only — it's slow)
    ...
    plot_feature_distributions_by_cluster(selected_features, kmeans_labels, CLUSTERING_FEATURES)
